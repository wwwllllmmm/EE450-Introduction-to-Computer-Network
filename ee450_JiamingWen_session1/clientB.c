...
#define PORT "26003"          //  // the TCP port of serverM which client B connects to
...
int main(int argc, char *argv[])
{
    ...
    if (2 != argc && 4 != argc)
    { 
        fprintf(stderr, "usage: ./clientB <username1> or \n usage: ./clientB <username1> <username2> <transfer amount>\n");
        exit(1);
    }
    ...
    /*----------------------------------------------------------------------------------------------
       ...
       4 :  if transaction fails due to insufficient balanc
       -*/
    if (4 == argc)
    {
